            ...
            <div class="container mt-4" style="border: 1px solid #c1c1c1;">
                <form action="{{route('category.update', ['id' =>$data->id] )}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 mt-2">
                        ...
                        <input type="text" name="title" id="title" class="form-control" placeholder="Enter New Category Title" value="{{ $data->title }}">
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" name="description" id="description" cols="30" rows="9" style="resize: none;" placeholder="Enter Category Description">{{ $data->description }}</textarea>
                        @error('description')
                        <p class="validate m-1">{{ $message }}</p>
                        @enderror
                    </div>
