...
<section class="news__section theme-100">
    <div class="custom-container">
        ...
        <div class="category__grid">
            @if(isset($data['latest_featured']))
            <div class="grid__card">
                <div class="card__img">
                    <a href="{{route('site.single_post' , $data['latest_featured']->slug)}}" class="image-size-70">
                        <img src="{{asset('/uploads/post/' . $data['latest_featured']->thumbnail)}}" alt="इजरायल–हमास युद्धमा यसरी हुँदैछ क्रिप्टोकरेन्सीको प्रयोग">
                    </a>
                </div>
                <div class="card__details">
                    <h3 class="card__title line-clamp-3">
                        <a href="{{route('site.single_post' , $data['latest_featured']->slug)}}">
                            {{$data['latest_featured']->title}}
                        </a>
                    </h3>
                    ...
                    <div class="post__meta">
                        <p class="meta author">
                            <a href="{{route('site.single_post' , $data['latest_featured']->slug)}}">
                                {{$data['latest_featured']->user->name}}
                            </a>
                        </p>

                        <p class="meta post__date">
                            {{$data['latest_featured']->created_at->format('D-d-M-Y')}}
                        </p>
                    </div>
    ...
    <div class="custom-container">
        ...
        <div class="col-lg-9 order-1 order-lg-2">
            <div class="browse__more-grid">
                ...
                <div class="profileNews__grid">
                    @if(isset($data['other_featured']))
                    @foreach($data['other_featured'] as $post)
                    <div class="grid__card">
                        <div class="card__img">
                            <a href="{{ route('site.single_post', $post->slug)}}" class="image-size-70">
                                <img src="{{asset('/uploads/post/' . $post->thumbnail)}}" alt="{{$post->title}}">
